                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                ...
                                @foreach($departments as $department)
                                    <option value="{{$department->id}}" @if($department->id == $usuario->user_data->department) selected = "selected" @endif >{{$department->name}}</option>
                                @endforeach
                            </select>
                            @error('role')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>>
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                ...
                                <option value="{{$role->id}}" @if($usuario->getRoleNames()->contains($role->name)) selected = "selected" @endif>{{$role->name}}</option>
                                @endforeach
                            </select>
                            @error('role')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>>
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                ...
                                <option value="{{$item->id}}" @if($item->id == $usuario->project) selected = "selected" @endif  >{{$item->empresa}}</option>
                                @endforeach
                            </select>
                            @error('empresa')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>>
